(function(module) {
    ...
    User.getRandom = function(callback) {
        storage.srandmember("users", function(error, id) {
            if (error) {
            ...
            user.load(function(error) {
                ...
                if (!id) {
                    return callback(new Error("No random user found"));
                }
    ...
    User.prototype.setName = function(name) {
        console.log("name for", this.id, name);
        this.data.name = name;
    };
    ...
    User.prototype.acceptGame = function(gameId, word, callback) {
        var self = this,
        ...
        game.load(function(error) {
            ...
            game.set("secondWord", word.toUpperCase());
            game.save(function(error) {
                if (error) {
                    return callback(error);
                }
