    ...
    Game.prototype.exportFor = function(user, callback) {
        ...
        if (this.data.opponent == userId || this.data.started == userId) {
            ...
            function resume() {
                ...
                if (userId == self.data.opponent) {
                    result.i_hang_up = self.data.firstHangUp;
                    result.i_won     = self.data.secondWon;
                    result.i_hanged  = self.data.secondHangUp;
                    result.i_lost    = self.data.firstWon;

                    result.partner = self.data.started;
                    result.word    = self.data.firstWord;
                } else {
                    result.i_hang_up = self.data.secondHangUp;
                    result.i_won     = self.data.firstWon;
                    result.i_hanged  = self.data.firstHangUp;
                    result.i_lost    = self.data.secondWon;
